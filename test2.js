...
function extractWorld(text,desiredLenght){
    var worldsArr = text.split(" ");
    var extracted;
    extracted = worldsArr.filter(function(word){
        return world.length > 4;
    });
}
